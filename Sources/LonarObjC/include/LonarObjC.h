// Declarations for the undocumented IOAVService I2C API used for DDC/CI on
// Apple Silicon. Symbols live in CoreDisplay.framework / IOKit.framework.
// Adapted from waydabber/AppleSiliconDDC (MIT).
